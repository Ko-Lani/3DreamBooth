...
class MMDoubleStreamBlock(nn.Module):
    ...
    def forward(
        ...
        txt_q, txt_k, txt_v = _lora_forward_masked(
            ...
            "default", txt_modulated, txt_span_mask,
        )
        ...
        (txt_proj_out,) = _lora_forward_masked([self.txt_attn_proj], "default", txt_attn, txt_span_mask)
        txt = txt + apply_gate(txt_proj_out, gate=txt_mod1_gate)
        txt = txt + apply_gate(
